...
#### 15. Estimar el modelo logistico de doble limite con todas las variables. Existen cambios frente al primer modelo logistico estimado con respecto a sus coeficientes?
```{r}
